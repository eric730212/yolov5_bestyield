...
from barcode_detecter_simple3 import barcode_sn
import os
import time
import shutil
...
class TestLayout(Widget):
    ...
    def clear(self):
        ...
        self.img7.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/background_pic/b.jpg'
        self.img8.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/background_pic/b.jpg'
        pass
    ...
    def click_me(self):
        ...
        self.img7.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/background_pic/w.jpg'
        self.img8.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/background_pic/w.jpg'
    ...
    def detect(self):
        detect_return = run()
        self.img1.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/1.jpg'
        self.img2.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/2.jpg'
        self.img3.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/3.jpg'
        self.img4.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/4.jpg'
        self.img5.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/5.jpg'
        self.img6.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/6.jpg'
        self.img7.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/7.jpg'
        self.img8.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/detect/8.jpg'
        if detect_return == 'OK':
            self.fire_popup()
        else:
            # 把問題點全部列出
    ...
    def take_pic_kivy(self):
        ...
        try:
            ...
            cv2.imwrite('./dataset2/test_kivy/6.jpg', frame6)
        try:
            cv2.imwrite('./dataset2/test_kivy/7.jpg', frame7)

        except:
            file = open('./dataset2/test_kivy/7.jpg', 'a+')
            file.close()
            cv2.imwrite('./dataset2/test_kivy/7.jpg', frame7)
        try:
            cv2.imwrite('./dataset2/test_kivy/8.jpg', frame8)

        except:
            file = open('./dataset2/test_kivy/8.jpg', 'a+')
            file.close()
            cv2.imwrite('./dataset2/test_kivy/8.jpg', frame8)
        ...
        try:
            ...
            self.img7.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/test_kivy/7.jpg'
            self.img8.source = 'C:/Users/Server/PycharmProjects/yolov5/dataset2/test_kivy/8.jpg'
            self.img1.reload()
            self.img2.reload()
            self.img3.reload()
            self.img4.reload()
